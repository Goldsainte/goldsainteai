CREATE TABLE public.trip_wishlists (
...
CREATE INDEX idx_trip_wishlists_user ON public.trip_wishlists(user_id);
CREATE INDEX idx_trip_wishlists_trip ON public.trip_wishlists(trip_id);
