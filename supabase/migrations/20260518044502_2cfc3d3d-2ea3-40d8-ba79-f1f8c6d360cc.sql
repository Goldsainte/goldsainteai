...
DROP POLICY IF EXISTS "Service role can insert error logs" ON public.api_error_logs;
CREATE POLICY "Service role can insert error logs" ON public.api_error_logs FOR INSERT TO service_role WITH CHECK (true);
