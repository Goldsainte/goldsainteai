...
const STRINGS: { en: S } & Partial<Record<EmailLang, S>> = {
  en: {
    ...
    tagline: (s) => `${s} has sent you a private message regarding your trip.`,
    ...
    step5: 'Need help? Contact our concierge team.',
  ...
  fr: {
    ...
    tagline: (s) => `${s} vous a envoyé un message privé concernant votre voyage.`,
    ...
    step5: "Besoin d'aide ? Contactez notre équipe de conciergerie.",
  ...
  es: {
    ...
    tagline: (s) => `${s} te ha enviado un mensaje privado sobre tu viaje.`,
    ...
    step5: '¿Necesitas ayuda? Contacta con nuestro equipo de conserjería.',
  ...
  de: {
    ...
    tagline: (s) => `${s} hat Ihnen eine private Nachricht zu Ihrer Reise gesendet.`,
    ...
    step5: 'Brauchen Sie Hilfe? Kontaktieren Sie unser Concierge-Team.',
  ...
  it: {
    ...
    tagline: (s) => `${s} ti ha inviato un messaggio privato sul tuo viaggio.`,
    ...
    step5: 'Serve aiuto? Contatta il nostro team concierge.',
  ...
  pt: {
    ...
    tagline: (s) => `${s} enviou uma mensagem privada sobre sua viagem.`,
    ...
    step5: 'Precisa de ajuda? Fale com nossa equipe de concierge.',
    cta: 'Abrir conversa',
  },
  ar: {
    ...
    tagline: (s) => `أرسل لك ${s} رسالة خاصة بشأن رحلتك.`,
    ...
    step5: 'تحتاج مساعدة؟ تواصل مع فريق الكونسيرج لدينا.',
    cta: 'افتح المحادثة',
  },
  ja: {
    ...
    tagline: (s) => `${s} さんから旅に関するプライベートメッセージが届きました。`,
    ...
    step5: 'お困りですか？コンシェルジュチームへご連絡ください。',
    cta: '会話を開く',
  },
  ko: {
    ...
    tagline: (s) => `${s}님이 여행에 관한 비공개 메시지를 보냈습니다.`,
    ...
    step5: '도움이 필요하신가요? 컨시어지 팀에 연락하세요.',
    cta: '대화 열기',
  },
  zh: {
    subject: (s) => `来自 ${s} 的新消息`,
    title: (s) => `来自 ${s} 的新消息`,
    headline: '你有一条新消息。',
    tagline: (s) => `${s} 就你的旅程给你发来了一条私信。`,
    lede: '一条新消息正在你的 Goldsainte 收件箱中等候。为保护双方，所有对话都安全地留在平台内。',
    step1: '打开会话，阅读完整消息。',
    step2: '直接在面板中回复。',
    step3: '按照条款，所有沟通必须留在平台内。',
    step4: '附件与提案会自动保存。',
    step5: '需要帮助？请联系我们的礼宾团队。',
    cta: '打开会话',
  },
}

export const NewMessageTravelerEmail = ({ conversationId, senderName, lang }: Props) => {
