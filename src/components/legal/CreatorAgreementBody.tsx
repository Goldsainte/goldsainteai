/* CreatorAgreementBody — the full Creator Partnership Agreement text.
 * Extracted 29 Jul from LegalCreatorAgreementPage so the SAME words render in
 * two places: the public /legal/creator-agreement page and the scroll-gated
 * acceptance step in creator onboarding. Edit the agreement HERE only —
 * both surfaces update together, and the acceptance content-hash stays honest.
 * Bump CREATOR_AGREEMENT_VERSION whenever the text meaningfully changes. */
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import {
  AlertCircle, Bot, Briefcase, Clock, Eye, FileText, Gavel, Handshake,
  Lock, Mail, Percent, RefreshCw, Share2, Sparkles, UserCheck,
} from 'lucide-react';
...
export function CreatorAgreementBody() {
  return (
