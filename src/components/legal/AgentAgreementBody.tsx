/* AgentAgreementBody — the full Agent Partnership Agreement text.
 * Extracted 30 Jul from LegalAgentAgreementPage so the SAME words render on
 * the public /legal/agent-agreement page and inside the scroll-gated
 * acceptance modal — agents now read and accept the actual agreement, not a
 * summary. Edit the agreement HERE only; both surfaces update together and
 * the acceptance content-hash stays honest.
 * Bump AGENT_AGREEMENT_VERSION whenever the text meaningfully changes. */
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import {
  AlertCircle, Briefcase, Clock, CreditCard, Eye, FileText, Gavel, Handshake, Lock, Mail, Percent, RefreshCw, Scale, Share2, ShieldCheck, Sparkles, UserCheck,
} from 'lucide-react';
...
export function AgentAgreementBody() {
  return (
