      ...
      <div className="mx-auto max-w-6xl rounded-3xl border border-[#BFAD72]/40 bg-gradient-to-r from-[#0a2225] via-[#0c4d47] to-[#0a2225] px-5 py-7 shadow-xl md:px-7 md:py-8">
        <div className="grid gap-5 md:grid-cols-[2fr,1.2fr] md:items-center">
          ...
          <div className="space-y-3 md:space-y-4">
            <div className="inline-flex items-center gap-2 rounded-full bg-black/40 px-4 py-1.5 text-sm font-medium text-[#E5DFC6] ring-1 ring-[#BFAD72]/50">
            ...
            <p className="max-w-xl text-base leading-relaxed text-[#E5DFC6]/90 md:text-lg">
            ...
            <ul className="space-y-2 text-base text-[#E5DFC6]/85">
            ...
            <div className="flex flex-col gap-2 pt-2 md:flex-row md:items-center">
              <button
                ...
                className="inline-flex items-center justify-center rounded-full bg-[#BFAD72] px-6 py-3 text-base font-semibold text-[#0a2225] shadow-sm hover:bg-[#d4c58d]"
              >
                <ArrowRightCircle className="mr-2 h-5 w-5" />
                Post a trip to the marketplace
              </button>

              <div className="inline-flex items-center gap-2 text-sm text-[#E5DFC6]/80">
          ...
          <div className="rounded-2xl bg-black/35 p-4 text-sm text-[#E5DFC6] shadow-inner ring-1 ring-[#BFAD72]/35">
