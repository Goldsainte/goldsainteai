...
const columns = [
  {
    eKey: "home.trustPlaque.c1e",
    eyebrow: "Curation",
    tKey: "home.trustPlaque.c1t",
    title: "Reviewed before it goes live",
    bKey: "home.trustPlaque.c1b",
  ...
  {
    eKey: "home.trustPlaque.c2e",
    eyebrow: "Identity",
    tKey: "home.trustPlaque.c2t",
    title: "Verified, every account",
    bKey: "home.trustPlaque.c2b",
  ...
  {
    eKey: "home.trustPlaque.c3e",
    eyebrow: "Payments",
    tKey: "home.trustPlaque.c3t",
    title: "Secured by Stripe",
    bKey: "home.trustPlaque.c3b",
  ...
  {
    eKey: "home.trustPlaque.c4e",
    eyebrow: "Support",
    tKey: "home.trustPlaque.c4t",
    title: "With you to boarding",
    bKey: "home.trustPlaque.c4b",
    ...
    <section className="border-t border-[#E5DFC6] bg-white py-16 md:py-24">
      <div className="mx-auto max-w-6xl px-4 text-center">
        <span
          ...
          style={inter}
        >
          {t("home.trustPlaque.eyebrow", "Trust & safety")}
        </span>
        ...
        <h2 className="mt-5 font-secondary text-[26px] text-[#0a2225] md:text-[34px]">
          {t("home.trustPlaque.h2", "Built to be trusted with your trip")}
        </h2>
        <p className="mx-auto mt-3 mb-10 max-w-xl text-[15px] leading-relaxed text-[#4a4a4a] md:mb-12">
          {t(
            "home.trustPlaque.sub",
            "Four commitments behind every booking — reviewed, verified, secured, and supported, start to finish."
          )}
        </p>
          ...
          <div className="relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
            {columns.map((c, i) => (
              <div key={c.eyebrow} className={`px-1 py-6 text-left md:px-7 md:py-5 lg:py-0 ${dividers(i)}`}>
                ...
                <p className="text-[14.5px] leading-relaxed text-[#4a4a4a]">{t(c.bKey, c.body)}</p>
              </div>
            ))}
          </div>
        </div>
