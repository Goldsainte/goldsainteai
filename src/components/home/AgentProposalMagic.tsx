        ...
        <div className="absolute inset-0 px-5 pt-10 pb-12 flex flex-col">
          ...
          <div className="flex-1 flex flex-col items-center justify-center gap-1.5">
            <div className="w-full max-w-[280px] rounded-xl bg-white/65 border border-[#E5DFC6] px-3 py-1.5 opacity-0 animate-[gs-rise_500ms_ease-out_500ms_forwards]">
              <p className="text-[9.5px] font-secondary italic text-[#0a2225]/55 truncate">Private safari · Anniversary · Tanzania</p>
            </div>
            <div className="w-full max-w-[290px] rounded-xl bg-white/85 border border-[#E5DFC6] px-3 py-1.5 opacity-0 animate-[gs-rise_500ms_ease-out_300ms_forwards]">
              <p className="text-[9.5px] font-secondary italic text-[#0a2225]/75 truncate">10-day Japan cultural journey · Family of 4</p>
            </div>
              ...
              <div className="px-3 py-2.5">
                ...
                <div className="mt-1.5 flex flex-wrap gap-1">
                  {["Cliffside Suites", "Private Sailing", "Michelin Dining"].map((t) => (
                    <span key={t} className="inline-flex items-center rounded-full bg-[#0c4d47]/5 border border-[#0c4d47]/15 px-1.5 py-0.5 text-[8px] font-secondary italic text-[#0c4d47]">{t}</span>
                  ))}
                </div>
              ...
              {days.map((d, i) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-[8px] uppercase tracking-[0.2em] text-[#C7A962]">Day {d.day}</p>
                    <p className="font-secondary italic text-[12px] text-[#0a2225] leading-tight truncate">{d.title}</p>
                    <p className="font-secondary italic text-[8.5px] text-[#6B7280] truncate">{d.sub}</p>
                  </div>
                  <div className="flex flex-col items-end gap-0.5 shrink-0 mr-2">
                    {d.tags.map((t, ti) => (
                      <span
                        key={t}
                        className="inline-flex items-center rounded-full bg-[#FBF7EC] border border-[#E5DFC6] px-1.5 py-0 text-[7.5px] text-[#0a2225]/70 opacity-0 animate-[gs-fade-in_400ms_ease-out_forwards]"
          ...
          <div className="relative w-full max-w-[300px] rounded-2xl bg-white border border-[#E5DFC6] shadow-[0_22px_50px_rgba(10,34,37,0.14)] overflow-hidden opacity-0 animate-[gs-rise_600ms_ease-out_forwards]">
            <div className="relative h-20 bg-gradient-to-br from-[#bcd3d0] via-[#7fa8a3] to-[#0c4d47] overflow-hidden">
              ...
              <div className="absolute bottom-2 left-3 right-3">
                ...
                <p className="text-[8px] uppercase tracking-[0.2em] text-[#C7A962] mt-0.5">Prepared for Sophia &amp; Marc</p>
              </div>
            </div>
            <div className="px-4 py-3">
              <div className="flex flex-wrap gap-1">
                {["Private Yacht", "Helicopter", "Cliffside Suites"].map((h, i) => (
                  <span
                    key={h}
                    className="inline-flex items-center rounded-full border border-[#E5DFC6] bg-[#FBF7EC] px-2 py-0.5 text-[8px] font-secondary italic text-[#0a2225] opacity-0 animate-[gs-rise_500ms_ease-out_forwards]"
            ...
            >
              ...
              <div className="mt-1 flex items-center gap-1.5 text-[8.5px] text-[#C7A962]/85">
