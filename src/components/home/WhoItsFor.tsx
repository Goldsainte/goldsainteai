      ...
      <div className="mx-auto max-w-6xl px-4">
        <div className="flex flex-col lg:flex-row lg:items-start gap-8 lg:gap-12">
          ...
          <div className="lg:w-[60%]">
            <div className="inline-flex items-center gap-2 rounded-full border border-[#E5DFC6] bg-[#BFAD72] px-3 py-1 text-xs uppercase tracking-[0.18em] text-[#0C4D47] mb-4">
              <span>Travelers</span>
            ...
            <h2 className="font-display text-[28px] leading-snug text-[#0a2225] md:text-[34px] mb-12">
