    ...
    <section className="bg-[#f7f3ea] text-[#0a2225]">
      <div className="mx-auto flex max-w-6xl flex-col gap-10 px-4 pb-12 pt-16 md:flex-row md:items-center md:pt-20">
        ...
        <div className="w-full md:w-[52%] space-y-5">
          <div className="inline-flex items-center gap-2 rounded-full border border-[#E5DFC6] bg-white/80 px-4 py-1.5 text-sm uppercase tracking-[0.18em] text-[#8D8D8D]">
            <span>Travelers</span>
          ...
          <h1 className="font-display text-3xl leading-snug md:text-5xl lg:text-[52px]">
            Where <em>inspiration</em> becomes a <em>storyboard</em> — and the perfect <em>creator + agent</em>{" "}
            team builds the trip.
          </h1>

          <p className="max-w-xl text-base md:text-lg leading-relaxed text-[#4a4a4a]">
          ...
          <div className="flex flex-wrap items-center gap-3 pt-1">
            <Link
              to="/post-trip"
              className="inline-flex items-center justify-center gap-2 rounded-full bg-[#0c4d47] px-6 py-3 text-base font-semibold text-[#E5DFC6] shadow-sm hover:bg-[#073331]"
            >
              Post a dream trip
            </Link>

            <div className="inline-flex flex-wrap gap-2 text-base">
              <Link
                to="/creators"
                className="rounded-full border border-[#BFAD72] bg-white px-5 py-2.5 font-semibold text-[#0a2225] hover:bg-[#f7f3ea]"
              >
                Browse creators
              </Link>
              <Link
                to="/agents"
                className="rounded-full border border-[#E5DFC6] bg-white px-5 py-2.5 font-semibold text-[#0a2225] hover:bg-[#f7f3ea]"
              >
                Browse agents
              </Link>
            </div>
          ...
          <p className="pt-2 text-base text-[#8D8D8D]">
          ...
          {/* Trust / promise line */}
          <p className="pt-1 text-sm text-[#8D8D8D] max-w-sm">
        ...
        <div className="w-full md:w-[48%]">
          <div className="relative mx-auto max-w-md">
            ...
            <div className="relative overflow-hidden rounded-[32px] bg-white/90 p-3 shadow-[0_18px_40px_rgba(10,34,37,0.18)]">
              ...
              {/* Caption card */}
              <div className="mt-3 rounded-2xl bg-[#0c4d47] px-4 py-3 text-base text-[#E5DFC6]">
                <p className="font-semibold mb-1.5">
                  Every trip begins with a storyboard.
                </p>
                <p className="text-sm text-[#E5DFC6]/90 leading-relaxed">
