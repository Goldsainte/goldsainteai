        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
          {collections.map((collection) => (
            <Card
              ...
              className="relative h-80 overflow-hidden cursor-pointer group border-luxury-gold/20 hover:shadow-xl transition-all duration-500"
              onClick={() => navigate(`/cocurated-journeys?destination=${collection.destination}`)}
            >
              <img
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <h3 className="font-secondary text-2xl text-white mb-2 drop-shadow-lg">
                  {collection.title}
                </h3>
