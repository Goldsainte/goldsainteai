      ...
      <div className="container px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="font-secondary text-3xl md:text-4xl font-bold mb-4">Frequently Asked Questions</h2>
          ...
          <Accordion type="single" collapsible className="space-y-4">
            {faqs.map((faq, index) => (
              ...
              >
                <AccordionTrigger className="font-secondary text-left font-semibold hover:no-underline py-6">
                  {faq.question}
                </AccordionTrigger>
