      ...
      <div className="w-full md:w-[400px] border-r flex flex-col bg-background">
        ...
        <div className="p-4 border-b">
          ...
          <Tabs defaultValue="primary" className="w-full">
            ...
            <TabsContent value="primary" className="mt-0 flex-1 flex flex-col">
              <div className="px-4 py-2 border-b bg-muted/30">
                <p className="text-xs text-muted-foreground">
                  Active bookings and accepted bids with travel agents
                </p>
              </div>
              <ConversationsList
                userId={user.id}
            ...
            <TabsContent value="general" className="mt-0 flex flex-col">
              <div className="px-4 py-2 border-b bg-muted/30">
                <p className="text-xs text-muted-foreground">
                  Casual conversations and follow-ups
                </p>
              </div>
              <ConversationsList
                userId={user.id}
            ...
            <TabsContent value="channels" className="mt-0 flex flex-col">
              <div className="px-4 py-2 border-b bg-muted/30">
                <p className="text-xs text-muted-foreground">
                  Group trips and community discussions
                </p>
              </div>
              <ConversationsList
                userId={user.id}
            ...
            <TabsContent value="requests" className="mt-0 flex flex-col">
              <div className="px-4 py-2 border-b bg-muted/30">
                <p className="text-xs text-muted-foreground">
