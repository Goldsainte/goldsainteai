...
export default function EscrowMilestonesPage() {
  return (
    <>
      <Helmet>
        <title>Escrow Milestones · Partner · Goldsainte</title>
      </Helmet>
      ...
      <div className="flex min-h-screen items-center justify-center bg-[#f7f3ea] px-4">
        <div className="max-w-md rounded-2xl border border-[#E5DFC6]/30 bg-white p-8 text-center shadow-sm">
          ...
          <p className="text-sm leading-relaxed text-[#4a4a4a]">
            This partner page requires database migrations to support booking_milestones
            and escrow tracking features.
          </p>
        </div>
      </div>
    </>
