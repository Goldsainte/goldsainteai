...
const STEPS: HowItWorksStep[] = [
  ...
  { number: "06", icon: HandCoins, title: "Earn on recommendations & tips", description: "Share a specialist's trip with your affiliate link and earn 2% of the booking value when your audience books — paid by Goldsainte out of our platform fee. And travelers can tip you straight from your profile and listings; tips land on your Stripe with everything else." },
