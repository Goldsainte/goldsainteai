...
export function TravelerOverviewTab({ profile, stats, onAvatarUpdate }: TravelerOverviewTabProps) {
  ...
  const steps = [
    {
      n: "01",
      title: t("dash.t.hw1", "Tell us your trip"),
      body: t("dash.t.hw1b", "Share where, when, who's travelling and the kind of experience you're after."),
    },
    {
      n: "02",
      title: t("dash.t.hw2", "We curate proposals"),
      body: t("dash.t.hw2b", "Trusted creators and agents respond with bespoke itineraries — privately, on-platform."),
    },
    {
      n: "03",
      title: t("dash.t.hw3", "Confirm with confidence"),
      body: t("dash.t.hw3b", "Compare, message, and book through Goldsainte. Payments are protected end-to-end."),
    },
  ];
    ...
    <div className="space-y-12">
      ...
      <section className="border-t border-[#0a2225]/10 pt-8 md:pt-10">
        ...
        <h2 className="mt-3 md:mt-4 font-secondary text-[28px] md:text-5xl leading-[1.15] text-[#0a2225] max-w-2xl">
          {t("dash.t.heroTitle", "A quieter way to design the journeys that matter.")}
        </h2>
        <p className="mt-4 md:mt-5 max-w-xl text-[15px] leading-relaxed text-[#0a2225]/65">
          {t("dash.t.heroSub", "Tell us about a trip you're dreaming of — we'll bring the right creators and agents to design it with you.")}
        </p>
        ...
        <div className="mt-7 md:mt-8 flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-x-8">
          ...
          >
            <Link to="/post-trip">{t("dash.t.requestTrip", "Request a Trip")}</Link>
          </Button>
          <Link
            to="/marketplace"
          ...
          >
            {t("dash.t.browseLower", "Browse the marketplace")}
      ...
      <section className="border-t border-[#0a2225]/10 pt-8 md:pt-10">
        <p className="text-[10px] md:text-[11px] uppercase tracking-[0.32em] text-[#0c4d47]/70 mb-6 md:mb-8">
          {t("dash.t.hwHeader", "How Goldsainte works for you")}
        </p>
      ...
      {isFirstTimeUser && (
        <section className="border-t border-[#0a2225]/10 pt-8 md:pt-10">
          <p className="text-[11px] font-medium uppercase tracking-[0.2em] text-[#9A9384] mb-2">
            {t("dash.t.welcomeGs", "Welcome to Goldsainte")}
          </p>
          <h2 className="font-secondary text-2xl text-[#0a2225] mb-2">
            {t("dash.t.firstTrip", "Let's plan your first trip")}
          </h2>
          <p className="text-sm text-[#6B7280] mb-6">
            {t("dash.t.threeWays", "Three ways to get started — pick whichever feels right.")}
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            ...
            >
              ...
              <p className="font-secondary text-base text-[#0a2225] mb-1">{t("dash.t.cardBrowse", "Browse Trips")}</p>
              <p className="text-xs text-[#6B7280]">{t("dash.t.cardBrowseSub", "Explore curated journeys ready to book.")}</p>
            </Link>
            ...
            >
              ...
              <p className="font-secondary text-base text-[#0a2225] mb-1">{t("dash.t.cardDream", "Tell Us Your Dream")}</p>
              <p className="text-xs text-[#6B7280]">
                {t("dash.t.cardDreamSub", "Post a trip request and receive personalized proposals.")}
              </p>
            </Link>
            ...
            >
              ...
              <p className="font-secondary text-base text-[#0a2225] mb-1">{t("dash.t.cardExplore", "Explore the Marketplace")}</p>
              <p className="text-xs text-[#6B7280]">{t("dash.t.cardExploreSub", "Discover curated trips, guides, and bundles.")}</p>
            </Link>
          </div>
        </section>
      )}
        ...
        <section className="border-t border-[#0a2225]/10 pt-8 flex flex-wrap gap-x-12 gap-y-4">
          <div>
            ...
            <p className="text-[11px] uppercase tracking-[0.28em] text-[#0a2225]/55 mt-1">
              {t("dash.t.openRequests", "Open requests")}
            </p>
          </div>
          <div>
            <p className="font-secondary text-3xl text-[#0a2225]">{stats.bookings}</p>
            <p className="text-[11px] uppercase tracking-[0.28em] text-[#0a2225]/55 mt-1">
              {t("dash.t.confirmedJourneys", "Confirmed journeys")}
            </p>
          </div>
        </section>
      )}
