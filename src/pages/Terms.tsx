    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <nav className="mb-12 p-6 bg-muted/50 rounded-lg border">
        ...
        <ul className="space-y-2 text-base">
          <li><a href="#section-a" className="text-primary hover:underline">Section A: General Terms</a></li>
          <li><a href="#section-b" className="text-primary hover:underline">Section B: Accommodations</a></li>
          <li><a href="#section-c" className="text-primary hover:underline">Section C: Attractions</a></li>
          <li><a href="#section-d" className="text-primary hover:underline">Section D: Car Rentals</a></li>
          <li><a href="#section-e" className="text-primary hover:underline">Section E: Flights</a></li>
          <li><a href="#section-f" className="text-primary hover:underline">Section F: Private and Public Transportation</a></li>
          <li><a href="#section-g" className="text-primary hover:underline">Section G: Cruises</a></li>
          <li><a href="#dictionary" className="text-primary hover:underline">Goldsainte Dictionary</a></li>
        </ul>
      </nav>

      {/* Section A: General Terms */}
      <section id="section-a" className="mb-12 scroll-mt-20">
        <h2 className="text-3xl font-bold mb-6 border-b pb-3">Section A: General Terms</h2>
        
        <div className="space-y-8 leading-relaxed">
          <div id="a1">
            <h3 className="text-2xl font-semibold mb-3">A1. Definitions</h3>
          ...
          <div id="a2">
            <h3 className="text-2xl font-semibold mb-3">A2. About These Terms</h3>
          ...
          <div id="a3">
            <h3 className="text-2xl font-semibold mb-3">A3. About Goldsainte</h3>
          ...
          <div id="a4">
            <h3 className="text-2xl font-semibold mb-3">A4. Our Platform</h3>
          ...
          <div id="a5">
            <h3 className="text-2xl font-semibold mb-3">A5. Our Values</h3>
          ...
          <div id="a6">
            <h3 className="text-2xl font-semibold mb-3">A6. Your Experience on Goldsainte</h3>
          ...
          <div id="a7">
            <h3 className="text-2xl font-semibold mb-3">A7. Prices and Payments</h3>
          ...
          <div id="a8">
            <h3 className="text-2xl font-semibold mb-3">A8. Policies</h3>
          ...
          <div id="a9">
            <h3 className="text-2xl font-semibold mb-3">A9. Privacy and Cookies</h3>
          ...
          <div id="a10">
            <h3 className="text-2xl font-semibold mb-3">A10. Accessibility Requests</h3>
          ...
          <div id="a12">
            <h3 className="text-2xl font-semibold mb-3">A12. Insurance</h3>
          ...
          <div id="a13">
            <h3 className="text-2xl font-semibold mb-3">A13. Goldsainte Rewards & Creator Incentives</h3>
          ...
          <div id="a14">
            <h3 className="text-2xl font-semibold mb-3">A14. Wallet, Credits & Payments</h3>
          ...
          <div id="a15">
            <h3 className="text-2xl font-semibold mb-3">A15. Intellectual Property Rights</h3>
          ...
          <div id="a16">
            <h3 className="text-2xl font-semibold mb-3">A16. Customer Support & Complaints</h3>
          ...
          <div id="a17">
            <h3 className="text-2xl font-semibold mb-3">A17. Communication with Service Providers</h3>
          ...
          <div id="a18">
            <h3 className="text-2xl font-semibold mb-3">A18. Measures Against Unacceptable Behavior</h3>
          ...
          <div id="a19">
            <h3 className="text-2xl font-semibold mb-3">A19. Limitation of Liability</h3>
          ...
          <div id="a20">
            <h3 className="text-2xl font-semibold mb-3">A20. Arbitration Agreement</h3>
            ...
            <h4 className="text-xl font-semibold mb-3 mt-6">Applicability</h4>
            ...
            <h4 className="text-xl font-semibold mb-3 mt-6">Internal Review Procedure</h4>
            ...
            <h4 className="text-xl font-semibold mb-3 mt-6">Waiver of Jury Trial</h4>
            ...
            <h4 className="text-xl font-semibold mb-3 mt-6">Waiver of Class Action</h4>
            ...
            <h4 className="text-xl font-semibold mb-3 mt-6">Rules and Forum</h4>
            ...
            <h4 className="text-xl font-semibold mb-3 mt-6">Arbitrator</h4>
            ...
            <h4 className="text-xl font-semibold mb-3 mt-6">Authority</h4>
            ...
            <h4 className="text-xl font-semibold mb-3 mt-6">Attorneys' Fees and Costs</h4>
            ...
            <h4 className="text-xl font-semibold mb-3 mt-6">Batch Arbitration</h4>
            ...
            <h4 className="text-xl font-semibold mb-3 mt-6">Invalidity, Expiration, or Severability</h4>
            ...
            <h4 className="text-xl font-semibold mb-3 mt-6">30-Day Right to Opt Out</h4>
            ...
            <h4 className="text-xl font-semibold mb-3 mt-6">Governing Courts and Law</h4>
      ...
      <section id="section-b" className="mb-12 scroll-mt-20">
        <h2 className="text-3xl font-bold mb-6 border-b pb-3">Section B: Accommodations</h2>
        
        <div className="space-y-8 leading-relaxed">
          <div id="b1">
            <h3 className="text-2xl font-semibold mb-3">B1. Scope of this section</h3>
          ...
          <div id="b2">
            <h3 className="text-2xl font-semibold mb-3">B2. Contractual relationship</h3>
          ...
          <div id="b3">
            <h3 className="text-2xl font-semibold mb-3">B3. What Goldsainte will do</h3>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <div id="b4">
            <h3 className="text-2xl font-semibold mb-3">B4. What you need to do</h3>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <div id="b5">
            <h3 className="text-2xl font-semibold mb-3">B5. Price and payment</h3>
          ...
          <div id="b6">
            <h3 className="text-2xl font-semibold mb-3">B6. Amendments, cancellations, and refunds</h3>
          ...
          <div id="b7">
            <h3 className="text-2xl font-semibold mb-3">B7. What else do you need to know?</h3>
            <ul className="list-disc pl-6 space-y-2">
      ...
      <section id="section-c" className="mb-12 scroll-mt-20">
        <h2 className="text-3xl font-bold mb-6 border-b pb-3">Section C: Attractions</h2>
        
        <div className="space-y-8 leading-relaxed">
          <div id="c1">
            <h3 className="text-2xl font-semibold mb-3">C1. Scope of this section</h3>
          ...
          <div id="c2">
            <h3 className="text-2xl font-semibold mb-3">C2. Contractual relationship</h3>
          ...
          <div id="c3">
            <h3 className="text-2xl font-semibold mb-3">C3. What Goldsainte will do</h3>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <div id="c4">
            <h3 className="text-2xl font-semibold mb-3">C4. What you need to do</h3>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <div id="c5">
            <h3 className="text-2xl font-semibold mb-3">C5. Price and payment</h3>
          ...
          <div id="c6">
            <h3 className="text-2xl font-semibold mb-3">C6. Amendments, cancellations, and refunds</h3>
          ...
          <div id="c7">
            <h3 className="text-2xl font-semibold mb-3">C7. What else do you need to know?</h3>
            <ul className="list-disc pl-6 space-y-2">
      ...
      <section id="section-d" className="mb-12 scroll-mt-20">
        <h2 className="text-3xl font-bold mb-6 border-b pb-3">Section D: Car Rentals</h2>
        
        <div className="space-y-8 leading-relaxed">
          <div id="d1">
            <h3 className="text-2xl font-semibold mb-3">D1. Scope of this section</h3>
          ...
          <div id="d2">
            <h3 className="text-2xl font-semibold mb-3">D2. Contractual relationship</h3>
          ...
          <div id="d3">
            <h3 className="text-2xl font-semibold mb-3">D3. What Goldsainte will do</h3>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <div id="d4">
            <h3 className="text-2xl font-semibold mb-3">D4. What you need to do</h3>
          ...
          <div id="d5">
            <h3 className="text-2xl font-semibold mb-3">D5. Price and payment</h3>
          ...
          <div id="d6">
            <h3 className="text-2xl font-semibold mb-3">D6. Amendments, cancellations, and refunds</h3>
          ...
          <div id="d7">
            <h3 className="text-2xl font-semibold mb-3">D7. What else do you need to know?</h3>
            <ul className="list-disc pl-6 space-y-2">
      ...
      {/* Section E: Flights */}
      <section id="section-e" className="mb-12 scroll-mt-20">
        <h2 className="text-3xl font-bold mb-6 border-b pb-3">Section E: Flights</h2>
        
        <div className="space-y-8 leading-relaxed">
          <div id="e1">
            <h3 className="text-2xl font-semibold mb-3">E1. Scope of this section</h3>
          ...
          <div id="e2">
            <h3 className="text-2xl font-semibold mb-3">E2. Contractual relationship</h3>
          ...
          <div id="e3">
            <h3 className="text-2xl font-semibold mb-3">E3. What Goldsainte will do</h3>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <div id="e4">
            <h3 className="text-2xl font-semibold mb-3">E4. What you need to do</h3>
          ...
          <div id="e5">
            <h3 className="text-2xl font-semibold mb-3">E5. Price and payment</h3>
            <p className="mb-3"><strong>What's Typically Included:</strong></p>
            <ul className="list-disc pl-6 space-y-2 mb-4">
              <li>Base airfare</li>
          ...
          <div id="e6">
            <h3 className="text-2xl font-semibold mb-3">E6. Amendments, cancellations, and refunds</h3>
          ...
          <div id="e7">
            <h3 className="text-2xl font-semibold mb-3">E7. What else do you need to know?</h3>
            
            <h4 className="text-xl font-semibold mb-2 mt-4">Code Share</h4>
            ...
            <h4 className="text-xl font-semibold mb-2 mt-4">Prohibited Practices</h4>
            <ul className="list-disc pl-6 space-y-2 mb-4">
            ...
            <h4 className="text-xl font-semibold mb-2 mt-4">Overbooking</h4>
            ...
            <h4 className="text-xl font-semibold mb-2 mt-4">Use of Flight Segments</h4>
            ...
            <h4 className="text-xl font-semibold mb-2 mt-4">One-way vs. Round-trip Tickets</h4>
            ...
            <h4 className="text-xl font-semibold mb-2 mt-4">International Travel</h4>
            <ul className="list-disc pl-6 space-y-2 mb-4">
            ...
            <h4 className="text-xl font-semibold mb-2 mt-4">Additional Charges and Fees</h4>
            <ul className="list-disc pl-6 space-y-2 mb-4">
            ...
            <h4 className="text-xl font-semibold mb-2 mt-4">Boarding Requirements</h4>
            <ul className="list-disc pl-6 space-y-2 mb-4">
            ...
            <h4 className="text-xl font-semibold mb-2 mt-4">Dangerous Goods</h4>
            ...
            <h4 className="text-xl font-semibold mb-2 mt-4">EU Regulation 261/2004</h4>
      ...
      <section id="section-f" className="mb-12 scroll-mt-20">
        <h2 className="text-3xl font-bold mb-6 border-b pb-3">Section F: Private and Public Transportation</h2>
        
        <div className="space-y-8 leading-relaxed">
          <div id="f1">
            <h3 className="text-2xl font-semibold mb-3">F1. Scope of this section</h3>
          ...
          <div id="f2">
            <h3 className="text-2xl font-semibold mb-3">F2. Contractual relationship</h3>
          ...
          <div id="f3">
            <h3 className="text-2xl font-semibold mb-3">F3. What we will do</h3>
            <ul className="list-disc pl-6 space-y-2 mb-4">
          ...
          <div id="f4">
            <h3 className="text-2xl font-semibold mb-3">F4. What you need to do</h3>
            <ul className="list-disc pl-6 space-y-2 mb-4">
          ...
          <div id="f5">
            <h3 className="text-2xl font-semibold mb-3">F5. Price and payment</h3>
          ...
          <div id="f6">
            <h3 className="text-2xl font-semibold mb-3">F6. Amendments, cancellations, and refunds</h3>
            
            <h4 className="text-xl font-semibold mb-3 mt-4">Cancellation</h4>
            ...
            <h4 className="text-xl font-semibold mb-3 mt-6">Amendments</h4>
            ...
            <h4 className="text-xl font-semibold mb-3 mt-6">Refunds</h4>
            <ol className="list-decimal pl-6 space-y-2">
          ...
          <div id="f7">
            <h3 className="text-2xl font-semibold mb-3">F7. What else do you need to know?</h3>
            <ul className="list-disc pl-6 space-y-2">
      ...
      {/* Section G: Cruises */}
      <section id="section-g" className="mb-12 scroll-mt-20">
        <h2 className="text-3xl font-bold mb-6 border-b pb-3">Section G: Cruises</h2>
      ...
      <section id="dictionary" className="mb-12 scroll-mt-20">
        <h2 className="text-3xl font-bold mb-6 border-b pb-3">Goldsainte Dictionary</h2>
        ...
        <div className="space-y-6 leading-relaxed">
          ...
          <div className="grid gap-4">
            <div className="border-l-4 border-primary pl-4">
              ...
              <p className="text-muted-foreground">Account through which you can book Travel Experiences on our Platform.</p>
            </div>

            <div className="border-l-4 border-primary pl-4">
              <h4 className="font-semibold mb-1">Accommodation</h4>
              <p className="text-muted-foreground">Provision of an accommodation service by a Service Provider (Section B).</p>
            </div>

            <div className="border-l-4 border-primary pl-4">
              <h4 className="font-semibold mb-1">Attraction</h4>
              <p className="text-muted-foreground">Provision of an Attraction service by a Service Provider (Section C).</p>
            </div>

            <div className="border-l-4 border-primary pl-4">
              <h4 className="font-semibold mb-1">Booking</h4>
              <p className="text-muted-foreground">Booking of a Travel Experience on our Platform, paid now or later.</p>
            </div>

            <div className="border-l-4 border-primary pl-4">
              <h4 className="font-semibold mb-1">Goldsainte / us / we / our</h4>
              <p className="text-muted-foreground">Goldsainte B.V. (accommodation, flights, attractions) or Goldsainte Transport Limited (ground transport).</p>
            </div>

            <div className="border-l-4 border-primary pl-4">
              <h4 className="font-semibold mb-1">Booking Confirmation</h4>
              <p className="text-muted-foreground">Confirmation email/voucher explaining Booking details.</p>
            </div>

            <div className="border-l-4 border-primary pl-4">
              <h4 className="font-semibold mb-1">Contract of Carriage</h4>
              <p className="text-muted-foreground">Contract between you and the Service Provider for Flights.</p>
            </div>

            <div className="border-l-4 border-primary pl-4">
              <h4 className="font-semibold mb-1">Flight</h4>
              <p className="text-muted-foreground">Provision of a flight by a Service Provider (Section E).</p>
            </div>

            <div className="border-l-4 border-primary pl-4">
              <h4 className="font-semibold mb-1">Main Driver</h4>
              <p className="text-muted-foreground">Driver whose details were entered at booking.</p>
            </div>

            <div className="border-l-4 border-primary pl-4">
              <h4 className="font-semibold mb-1">Platform</h4>
              <p className="text-muted-foreground">Website/app to book Travel Experiences, owned/managed by Goldsainte or affiliates.</p>
            </div>

            <div className="border-l-4 border-primary pl-4">
              <h4 className="font-semibold mb-1">Pre-Booked Private Transportation</h4>
              <p className="text-muted-foreground">Private vehicle requested ≥30 minutes before pick-up.</p>
            </div>

            <div className="border-l-4 border-primary pl-4">
              <h4 className="font-semibold mb-1">Private Transportation Journey</h4>
              <p className="text-muted-foreground">Journey details as set out in booking.</p>
            </div>

            <div className="border-l-4 border-primary pl-4">
              <h4 className="font-semibold mb-1">Public Transportation Journey</h4>
              <p className="text-muted-foreground">Journey details as set out in booking.</p>
            </div>

            <div className="border-l-4 border-primary pl-4">
              <h4 className="font-semibold mb-1">Rental / Car Rental</h4>
              <p className="text-muted-foreground">Car provision by Service Provider (Section D).</p>
            </div>

            <div className="border-l-4 border-primary pl-4">
              <h4 className="font-semibold mb-1">Shared Pre-Booked Private Transportation</h4>
              <p className="text-muted-foreground">Shared vehicle; individual seat purchase.</p>
            </div>

            <div className="border-l-4 border-primary pl-4">
              <h4 className="font-semibold mb-1">Rental Agreement</h4>
              <p className="text-muted-foreground">Contract signed at pick-up for Car Rental.</p>
            </div>

            <div className="border-l-4 border-primary pl-4">
              <h4 className="font-semibold mb-1">Rewards / Travel Credits / Cash Credits / Credit Card Cashback</h4>
              <p className="text-muted-foreground">Benefits or monetary credits.</p>
            </div>

            <div className="border-l-4 border-primary pl-4">
              <h4 className="font-semibold mb-1">Service Provider</h4>
              <p className="text-muted-foreground">Provider of a travel product/service on the Platform.</p>
            </div>

            <div className="border-l-4 border-primary pl-4">
              <h4 className="font-semibold mb-1">Services (F section)</h4>
              <p className="text-muted-foreground">Public or Private Transportation provision.</p>
            </div>

            <div className="border-l-4 border-primary pl-4">
              <h4 className="font-semibold mb-1">Terms</h4>
              <p className="text-muted-foreground">These terms of service.</p>
            </div>

            <div className="border-l-4 border-primary pl-4">
              <h4 className="font-semibold mb-1">Third-Party Aggregator</h4>
              <p className="text-muted-foreground">Intermediary or reseller of Travel Experiences.</p>
            </div>

            <div className="border-l-4 border-primary pl-4">
              <h4 className="font-semibold mb-1">Third-Party Terms</h4>
              <p className="text-muted-foreground">Contracts with Aggregator or airline (Flights).</p>
            </div>

            <div className="border-l-4 border-primary pl-4">
              <h4 className="font-semibold mb-1">Upfront Payment</h4>
              <p className="text-muted-foreground">Payment made at booking.</p>
            </div>

            <div className="border-l-4 border-primary pl-4">
              <h4 className="font-semibold mb-1">Wallet</h4>
              <p className="text-muted-foreground">Dashboard showing Rewards, Credits, and incentives.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="mt-16 pt-8 border-t text-center text-muted-foreground">
        ...
        <p className="text-sm">© 2025 Goldsainte. All rights reserved.</p>
      </footer>
