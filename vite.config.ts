...
export default defineConfig(({ mode }) => {
  ...
  define: {
    ...
    'import.meta.env.VITE_GOOGLE_MAPS_API_KEY': JSON.stringify(
      process.env.VITE_GOOGLE_MAPS_API_KEY ?? env.VITE_GOOGLE_MAPS_API_KEY ?? 'AIzaSyD7iKtXBdVBCP03hgxD_MjY7IC_-TcI43Y'
    ),
    ...
    'import.meta.env.VITE_GOOGLE_PLACES_API_KEY': JSON.stringify(
      process.env.VITE_GOOGLE_PLACES_API_KEY ?? env.VITE_GOOGLE_PLACES_API_KEY ?? 'AIzaSyD7iKtXBdVBCP03hgxD_MjY7IC_-TcI43Y'
    ),
